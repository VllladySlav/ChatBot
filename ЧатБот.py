...
{', '.join(topics_dictionary.keys())}.""")
                        ...
                        print("\n".join(topics_dictionary_1["фізика"]))
                        print("Бажаєте вийти із блоку «фізика» - напишіть «назад».")
...
{', '.join(topics_dictionary.keys())}.""")
                        ...
                        print_response(f"Не знайдено такої теми. Ви можете поставити мені запитання з таких тем:")
                        print("\n".join(topics_dictionary_1["математика"]))
                        print("Бажаєте вийти із блоку «математика» - напишіть «назад».")
...
{', '.join(topics_dictionary.keys())}.""")
                        ...
                        print_response(f"Не знайдено такої теми. Ви можете поставити мені запитання з таких тем:")
                        print("\n".join(topics_dictionary_1["географія"]))
                        print("Бажаєте вийти із блоку «географія» - напишіть «назад».")
...
{', '.join(topics_dictionary.keys())}.""")
                        ...
                        print_response(f"Не знайдено такої теми. Ви можете поставити мені запитання з таких тем:")
                        print("\n".join(topics_dictionary_1["філологія"]))
                        print("Бажаєте вийти із блоку «філологія» - напишіть «назад».")
...
{', '.join(topics_dictionary.keys())}.""")
                        ...
                        print_response(f"Не знайдено такої теми. Ви можете поставити мені запитання з таких тем:")
                        print("\n".join(topics_dictionary_1["астрономія"]))
                        print("Бажаєте вийти із блоку «астрономія» - напишіть «назад».")
...
{', '.join(topics_dictionary.keys())}.""")
                        ...
                        print_response(f"Не знайдено такої теми. Ви можете поставити мені запитання з таких тем:")
                        print("\n".join(topics_dictionary_1["загальні"]))
                        print("Бажаєте вийти із блоку «загальні» - напишіть «назад».")
        else:
